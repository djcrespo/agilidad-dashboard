<template>
  <div>
    ...
    <b-table
      ...
      :data="clients"
    >
      <b-table-column v-slot="props" cell-class="has-no-head-mobile is-image-cell">
        <div class="image">
      ...
      <b-table-column v-slot="props" label="Company" field="company" sortable>
        {{ props.row.company }}
      </b-table-column>
      <b-table-column v-slot="props" label="City" field="city" sortable>
        {{ props.row.city }}
      </b-table-column>
      <b-table-column v-slot="props" cell-class="is-progress-col" label="Progress" field="progress" sortable>
