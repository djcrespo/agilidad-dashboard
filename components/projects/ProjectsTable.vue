  ...
  <div>
    ...
    >
      ...
      <b-table-column
        ...
        centered
      >
        {{ props.row.projectDetails.name_project ? props.row.projectDetails.name_project : 'Sin nombre' }}
      </b-table-column>
      ...
      <b-table-column
        ...
        centered
      >
        {{ props.row.projectDetails.date_init ? new Date(props.row.projectDetails.date_init).toLocaleDateString() : 'Sin fecha' }}
      </b-table-column>
      ...
      <b-table-column
        ...
        centered
      >
        {{ props.row.projectDetails.date_end ? new Date(props.row.projectDetails.date_end).toLocaleDateString() : 'Sin fecha' }}
      </b-table-column>
